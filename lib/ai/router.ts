...
// Groq:   Fast responses, instant AI search, autocomplete
// Gemini: Packing lists, seasonal content, multimodal
// Claude: Complex multi-day itinerary planning (best reasoning)

export const AI_ROUTING: Record<AITask, AIProvider> = {
  search:   'groq',     // Ultra-fast temple search
  chat:     'groq',     // Quick Q&A chatbot
  checklist: 'gemini',  // Packing lists (large context)
  seasonal:  'gemini',  // Seasonal recommendations
  planner:   'claude',  // Complex multi-day itineraries
}
...
export async function routeAI(
  ...
  try {
    ...
    console.error(`AI provider ${provider} failed, attempting fallback:`, err)
    if (provider !== 'groq') {
...
**Dress Code:** [What to wear]`,
  ...
  seasonal: `You are DivyaDarshan's festival and seasonal guide. Provide detailed recommendations for the best temples to visit this month, organized by: Major Festivals happening, Best Weather destinations, Spiritual Significance, and Crowd Tips. Be enthusiastic but accurate. Focus on the unique experience each temple offers during this specific time.`,
}
