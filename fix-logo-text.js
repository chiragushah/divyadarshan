...
console.log('\n[1/1] Rewriting Logo.tsx...')
write('components/Logo.tsx', `import Image from 'next/image'
...
execSync('git commit -m "fix: Logo shows Divya Darshanam as real crisp text"', { stdio: 'inherit' })
