...
export default function Page() {
  return (
    <div style={{minHeight:'80vh',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'48px 24px',textAlign:'center',background:'#fff'}}>
      ...
      <h1 style={{fontFamily:"'Playfair Display',Georgia,serif",fontSize:'2.2rem',fontWeight:700,color:'#8B1A1A',marginBottom:12}}>Our Team</h1>
      <p style={{fontSize:'1.05rem',color:'#6B5B4E',maxWidth:480,lineHeight:1.8,marginBottom:32}}>Meet the passionate team behind DivyaDarshanam — developers, designers and pilgrims who believe in the power of sacred travel.</p>
