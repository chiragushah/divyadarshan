...
export const metadata: Metadata = {
  title: {
    default: 'DivyaDarshanam — India\'s Temple Explorer',
    template: '%s | DivyaDarshanam',
  },
  ...
  keywords: ['temples india', 'yatra planner', 'pilgrimage guide', 'hindu temples', 'temple darshan', 'divyadarshanam'],
  authors: [{ name: 'DivyaDarshanam' }],
  creator: 'DivyaDarshanam',
  openGraph: {
    type: 'website',
    locale: 'en_IN',
    url: 'https://divyadarshanam.in',
    siteName: 'DivyaDarshanam',
    title: 'DivyaDarshanam — India\'s Temple Explorer',
    description: 'Discover 350+ sacred temples. Plan your yatra with AI.',
    images: [{ url: '/og-image.jpg', width: 1200, height: 630 }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'DivyaDarshanam',
