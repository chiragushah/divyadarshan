...
write('components/SplashScreen.tsx', `'use client'
...
// ── Update layout to use SplashScreen instead of MusicPlayer ──
console.log('Updating layout.tsx...')
let layout = fs.readFileSync(path.join(P, 'app/layout.tsx'), 'utf8')

// Replace MusicPlayer with SplashScreen
layout = layout
  .replace("import MusicPlayer from '@/components/MusicPlayer'", "import SplashScreen from '@/components/SplashScreen'")
  .replace('<MusicPlayer />', '<SplashScreen />')
...
execSync('git commit -m "feat: sacred splash screen with music autoplay on click"', { stdio: 'inherit' })
