      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px" }}>
        <div style={{ display: "flex", alignItems: "center", height: 72, gap: 8 }}>
          ...
          <div className="hidden md:flex" style={{ alignItems: "center", gap: 10, marginLeft: "auto" }}>
            ...
            {/* Google Translate â€” sits inline in navbar, no floating */}
            <GoogleTranslate />
      ...
      {mobileOpen && (
        <div style={{ background: "#FFFFFF", borderTop: "1.5px solid #E8E8E8", padding: "12px 24px 20px", maxHeight: "85vh", overflowY: "auto" }}>
          ...
          <Link href="/manifest" onClick={() => setMobileOpen(false)}
            ...
            <div>
              <div style={{ fontWeight: 700, fontSize: 14, color: "var(--crimson)" }}>Manifest â€” Sankalp</div>
          ...
          <button
            ...
            ðŸ’› Contribute to DivyaDarshan
          </button>

          {/* Language selector â€” Google Translate widget inline */}
          <div style={{ marginBottom: 16, padding: "12px 16px", borderRadius: 10, border: "1px solid #F0F0F0", background: "#FAFAFA" }}>
            <div style={{ fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: ".08em", color: "#AAAAAA", marginBottom: 8 }}>ðŸŒ Select Language</div>
            <GoogleTranslate />
          </div>
