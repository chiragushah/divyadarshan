...
fs.writeFileSync(path.join(P, 'components/MusicPlayer.tsx'), component, 'utf8')
console.log('OK: MusicPlayer updated')

process.chdir(P)
execSync('git add components/MusicPlayer.tsx', { stdio: 'inherit' })
execSync('git commit -m "feat: bigger unmute banner at bottom of screen"', { stdio: 'inherit' })
