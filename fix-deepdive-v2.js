...
console.log('Rewriting DeepDiveSection...')
...
fs.writeFileSync(path.join(P, 'components/temple/DeepDiveSection.tsx'), component, 'utf8')
console.log('OK')

process.chdir(P)
execSync('git add "components/temple/DeepDiveSection.tsx"', { stdio: 'inherit' })
execSync('git commit -m "fix: DeepDive - replace broken embed with YouTube search cards"', { stdio: 'inherit' })
